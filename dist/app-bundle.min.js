...
// Module
exports.push([module.i, "/*\r\n * This file was auto-generated using SASS\r\n * You can manually modify it - but usually you will want to \r\n * Re-generate it using the SASS variables of your theme\r\n*/\n.po-wrapper .po-categories-list {\n  margin-bottom: 15px; }\n  .po-wrapper .po-categories-list .po-category-button {\n    font-weight: 400;\n    padding: 5px 10px;\n    cursor: pointer;\n    transition: background .3s ease, color .3s ease;\n    background: #e9ecef;\n    color: #343a40;\n    font-size: 14px; }\n    .po-wrapper .po-categories-list .po-category-button:hover, .po-wrapper .po-categories-list .po-category-button.co-active {\n      background: #ced4da; }\n\n.po-wrapper .po-wrapper-inner {\n  transition: opacity .4s ease-in-out;\n  padding: 15px; }\n  .po-wrapper .po-wrapper-inner .po-position {\n    padding: 15px;\n    transition: background .2s ease; }\n    .po-wrapper .po-wrapper-inner .po-position.po-odd {\n      background: #ecf0f1; }\n      .po-wrapper .po-wrapper-inner .po-position.po-odd:hover {\n        background: #dadada; }\n    .po-wrapper .po-wrapper-inner .po-position:hover {\n      background: #dadada; }\n      .po-wrapper .po-wrapper-inner .po-position:hover .co-link {\n        text-decoration: underline;\n        color: #4A148C; }\n    .po-wrapper .po-wrapper-inner .po-position h3 {\n      margin: 0; }\n    .po-wrapper .po-wrapper-inner .po-position .po-categories-list {\n      margin: 0 0 7px 0; }\n      .po-wrapper .po-wrapper-inner .po-position .po-categories-list > span {\n        font-size: 13px;\n        color: #adb5bd; }\n        .po-wrapper .po-wrapper-inner .po-position .po-categories-list > span:first-of-type:after {\n          content: \"\"; }\n        .po-wrapper .po-wrapper-inner .po-position .po-categories-list > span:after {\n          content: \",\"; }\n        .po-wrapper .po-wrapper-inner .po-position .po-categories-list > span:last-of-type:after {\n          content: \"\"; }\n  .po-wrapper .po-wrapper-inner .po-categories-container {\n    text-align: right; }\n    .po-wrapper .po-wrapper-inner .po-categories-container > span {\n      color: #4A148C;\n      font-weight: 600; }\n\n.po-admin-table-wrapper {\n  margin: 0 0 30px 0;\n  padding: 15px;\n  border-top: 1px solid #4A148C;\n  border-bottom: 1px solid #4A148C; }\n  .po-admin-table-wrapper .po-admin-warning {\n    color: #000;\n    font-size: 16px;\n    font-weight: 700; }\n", ""]);
...
var App = /** @class */ (function () {
    function App(moduleid) {
            ...
            $(appWrapper + " .po-category-button").click(function () {
                ...
                setTimeout(function () {
                    positionItems.each(function () {
                        ...
                        $(this).css('display', filter === 'nofilter' || filterElems.find(function (elem) {
                            return elem === filter;
                        }) ? 'inline-block' : 'none');
                    });
        ...
        this.getOdds = function (elements, positionItems) {
